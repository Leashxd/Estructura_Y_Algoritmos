...
queue *create_queue()
{
    ...
    out->head = NULL;
    out->back = NULL;
// Back es el final de la lista "Hacia la derecha"
// Head es el "principio"
...
// Se elimina al inicio "a la izquierda" de la cola
...
//Lo comentado no es necesario para hacer el pop
